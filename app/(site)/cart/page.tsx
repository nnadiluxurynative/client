                  ...
                  <div className="flex-1 min-w-0 pr-8">
                    ...
                    <div className="flex items-center mt-3">
                      <button
                        ...
                        className="w-6 h-6 border rounded-xs border-grey flex transition-all items-center cursor-pointer justify-center hover:border-gray-400"
                      >
                        <BsDash />
                      </button>
                      ...
                      <button
                        ...
                        className="w-6 h-6 border rounded-xs border-grey transition-all flex items-center justify-center hover:border-gray-400 cursor-pointer"
                      >
                        <BsPlus />
                      </button>
                    </div>
